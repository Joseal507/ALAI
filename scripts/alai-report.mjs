...
const control = one(`SELECT active_stage, mode, chat_priority_enabled FROM education_control WHERE id='main'`, {
  active_stage:'UNKNOWN',
  mode:'UNKNOWN',
  chat_priority_enabled:0
});
...
console.log('========================');
console.log('');
console.log(`🎯 Nivel activo: ${control.active_stage}`);
console.log(`⚙️ Modo: ${control.mode}`);
console.log(`💬 Chat priority: ${control.chat_priority_enabled ? 'ON' : 'OFF'}`);
console.log('');
